...
object Day15Part1Solver : Solver {
    ...
    private class Cave(val risks: Array<Array<Int>>) {
        ...
        private val width = if (risks.isEmpty()) 0 else risks.first().size
        private val height = risks.size
        ...
        fun costOf(point: Point): Int = risks[point.y][point.x]
    }
